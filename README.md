...
В конце данной части работы должны получиться следующие результаты:
- [ ] создана классовая структура, представляющая данные в требуемом виде;
- [ ] созданы классы, генерирующие XML-файлы и JSON-файлы, складывающие их в отдельные назначенные директории;
- [ ] новые классы покрыты логированием в достаточной степени;
- [ ] (дополнительно) проведён рефакторинг класса, генерирующего JSON-строки из коллекций.